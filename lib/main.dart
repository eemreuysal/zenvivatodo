...
void main() async {
  ...
  // Geliştirme sırasında Firebase emülatörlerini kullan
  if (kDebugMode) {
  ...
  Widget build(BuildContext context) {
    return Consumer<ThemeProvider>(
      builder: (_, themeProvider, _) {
        ...
        final updatedTheme = themeProvider.themeData.copyWith(textTheme: textTheme);

...
class AppTheme {
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    datePickerTheme: DatePickerThemeData(
      ...
      dayForegroundColor: WidgetStateProperty.all(AppColors.lightTextColor),
      yearForegroundColor: WidgetStateProperty.all(AppColors.lightTextColor),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    datePickerTheme: DatePickerThemeData(
      ...
      headerBackgroundColor: AppColors.primaryColor,
      headerForegroundColor: Colors.white,
      dayForegroundColor: WidgetStateProperty.all(AppColors.darkTextColor),
      yearForegroundColor: WidgetStateProperty.all(AppColors.darkTextColor),
      todayForegroundColor: WidgetStateProperty.all(AppColors.primaryColor),
      todayBackgroundColor: WidgetStateProperty.all(Colors.transparent),
      dayBackgroundColor: WidgetStateProperty.all(Colors.transparent),
      yearBackgroundColor: WidgetStateProperty.all(Colors.transparent),
